...
public class ListeMemoireProduitDAO implements ProduitDAO {
	...
	private ListeMemoireProduitDAO() {
		...
		this.donnees.add(new Produit(2, "Sonic te kiffe", "Inspir� par la saga S�ga (c'est plus fort que toi !), un pull 100% gamer qui te permettra de faire baver d'envie tes petits camarades de jeu.", 41.5, "pull1.png", 1));
		this.donnees.add(new Produit(6, "La chaleur des rennes", "Classique mais efficace, un bonnet dont l'�l�gance n''est pas � souligner, il vous grattera comme il faut !", 15, "bonnet0.png", 2)); 
		this.donnees.add(new Produit(12, "Dall", "Joyeux No�l avec nos petits lutins dansants !", 35, "bonnet1.png", 2)); 
	}
